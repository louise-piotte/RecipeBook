...
- Do not translate or rewrite the shared recipe ingredient text fields because RecipeBook keeps those source ingredient lines outside the bilingual text model.
